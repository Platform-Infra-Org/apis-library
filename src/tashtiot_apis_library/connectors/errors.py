"""Common error hierarchy used by the service clients (ArgoCD, Git, Vault, AWX)."""
...
class AWXError(ExternalServiceError):
    def __init__(self, status_code: int, detail: str) -> None:
        super().__init__(service_name="AWX", status_code=status_code, detail=detail)
